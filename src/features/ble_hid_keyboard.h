 ...
 *
 * Owns NimBLE host bring-up for the device. AirSpam and other BLE features
...
/* --- Shared NimBLE stack (HID + AirSpam) --- */

bool ble_hid_keyboard_stack_ready(void);
void ble_hid_keyboard_mark_stack_ready(void);

/** Pause connectable HID advertising (e.g. before AirSpam). */
